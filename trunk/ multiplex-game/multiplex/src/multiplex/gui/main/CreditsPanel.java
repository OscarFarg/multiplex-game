...
public class CreditsPanel extends JPanel implements MouseListener
{
	...
	public CreditsPanel(MainPanel mainPanel)
	{
		setLayout(null); 
	...
	public void paintComponent(Graphics g)
	{
		...
		g.drawImage(new ImageIcon(getClass().getClassLoader().getResource("multiplex/spelementen/images/credits.png")).getImage(),0, 0, getWidth(), getHeight(), null);
	}
